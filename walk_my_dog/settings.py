"""
Django settings for walk_my_dog project.
...
SECRET_KEY = 'django-insecure-5(sm$nd#3nbg*li2rv2y(*6pnr-s9np(0#=p(=@)q)@rmvw+)g'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['walk_the_dogs.herokuapp.com', 'localhost', '127.0.0.1']
...
WSGI_APPLICATION = 'walk_my_dog.wsgi.application'
